...
import com.example.a10118389.R;
import com.example.a10118389.activities.wisata;
import com.example.a10118389.adapter.MainAdapter;
import com.example.a10118389.decoration.LayoutMarginDecoration;
import com.example.a10118389.model.ModelMain;
import com.example.a10118389.utils.Tools;
...
public class MainActivity extends AppCompatActivity implements MainAdapter.onSelectData  {
    ...
    public void onSelected(ModelMain mdlMain) {
        switch (mdlMain.getTxtName()) {
            case "Wisata":
                startActivityForResult(new Intent(com.example.a10118389.activities.MainActivity.this, wisata.class), 1);
                break;
        }
    }
